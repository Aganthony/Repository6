...
# Update these imports to the correct path where your domain models and Django models are located
from pms.domain import model as domain_model # type: ignore
from pms_app import models as django_models # type: ignore
